// src/pages/Remeras.jsx - VERSIÓN MEJORADA
...
function Remeras() {
  ...
  // Filtrar solo productos de remeras
  useEffect(() => {
    if (!productsLoading && products.length > 0) {
      const remerasProducts = products.filter(product => 
        product.category && product.category.toLowerCase() === 'remeras'
      );
      
      console.log('👕 Productos de remeras:', remerasProducts.length);
      
      setFilteredProducts(remerasProducts);
      setLoading(false);
  ...
  if (loading || productsLoading) {
    return (
      <div className="remeras-page">
        <div className="loading">🔄 Cargando remeras...</div>
      </div>
    )
  }
  ...
  return (
    <div className="remeras-page">
      <header className="remeras-header">
        <div className="container">
          <img src={logo} alt="By Luciana" className="remeras-logo" />
          <h1 className="remeras-title">
            👕 Remeras
          </h1>
          <p className="remeras-subtitle">
      ...
      <main className="remeras-content">
        <div className="container">
          {filteredProducts.length === 0 ? (
            <div className="no-products">
              <div className="no-products-icon">👕</div>
              <h3>No hay productos de remeras</h3>
              <p>Los productos que agregues en la categoría "remeras" aparecerán aquí</p>
            ...
            <>
              <div className="remeras-stats">
                <p>📊 {filteredProducts.length} producto(s) de remeras</p>
              </div>
              
              <div className="remeras-products-grid">
                {filteredProducts.map(product => (
                  <div key={product._id} className="remeras-product-card">
                    <div 
      ...
      <footer className="remeras-footer">
        <div className="container">
