// src/pages/Calzados.jsx - VERSIÓN MEJORADA
...
function Calzados() {
  ...
  // Filtrar solo productos de calzados
  useEffect(() => {
    if (!productsLoading && products.length > 0) {
      const calzadosProducts = products.filter(product => 
        product.category && product.category.toLowerCase() === 'calzados'
      );
      
      console.log('👟 Productos de calzados:', calzadosProducts.length);
      
      setFilteredProducts(calzadosProducts);
      setLoading(false);
  ...
  if (loading || productsLoading) {
    return (
      <div className="calzados-page">
        <div className="loading">🔄 Cargando calzados...</div>
      </div>
    )
  }
          ...
          {filteredProducts.length === 0 ? (
            ...
            <>
              <div className="calzados-stats">
                <p>📊 {filteredProducts.length} producto(s) de calzados</p>
              </div>
